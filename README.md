...
- Add an optional hero background image (fog/snow) configurable in `_config.yml`.
- Provide a toggle for grayscale imagery intensity for photos and teasers.
